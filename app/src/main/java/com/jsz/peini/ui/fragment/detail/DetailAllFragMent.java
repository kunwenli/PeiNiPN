...
public class DetailAllFragMent extends BaseFragment {
    /**
     * 全部
     */
    String type = "";
    @InjectView(R.id.detail_all)
    RecyclerView mDetailAll;
    public List<ScoreHistoryListBean.DataBean> mList;
    public DetailAdapter mAdapter;

    @Override
    public View initViews() {
        return UiUtils.inflate(mActivity, R.layout.fragment_detailall);
    }

    @Override
    public void initData() {
        mList = new ArrayList<>();
        mDetailAll.setLayoutManager(new LinearLayoutManager(mActivity));
        mAdapter = new DetailAdapter(mActivity, mList);
        mDetailAll.setAdapter(mAdapter);
