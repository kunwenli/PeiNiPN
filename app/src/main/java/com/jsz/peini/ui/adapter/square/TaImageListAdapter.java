...
public class TaImageListAdapter extends BaseRecyclerViewAdapter {
    ...
    private MiImageListAdapter.OnClicPhotokListener mPhotokListener;

    public void setOnClicPhotokListener(MiImageListAdapter.OnClicPhotokListener photokListener) {
