package com.jsz.peini.ui.adapter.tabulation;
...
public class TabulationAdapter extends PagerAdapter {

    private final Activity TabulationAdaptermActivity;
    private final List<TabulationBean.TaskAllListBean> taskAllList;
    ...
    private TagAdapter<TabulationBean.TaskAllListBean.UserLabelBean> mAdapter;

    public void setOnItemClickListenter(OnItemClickListenter listenter) {
        this.listenter = listenter;
    }

    public TabulationAdapter(Activity mActivity, List<TabulationBean.TaskAllListBean> taskAllList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final TabulationBean.TaskAllListBean taskAllListBean = taskAllList.get(position);
        ...
        List<TabulationBean.TaskAllListBean.UserLabelBean> userLabel = taskAllListBean.getUserLabel();
        ...
        mTagFlowLayout.setAdapter(mAdapter = new TagAdapter<TabulationBean.TaskAllListBean.UserLabelBean>(userLabel) {
            @Override
            public View getView(FlowLayout parent, int position, TabulationBean.TaskAllListBean.UserLabelBean userLabelBean) {
