 ...
 */
public class TowRecyclerviewAdapter extends RecyclerView.Adapter {

    public final Activity mActivity;
    public final List<HotBean> mDistrictList;
    public final int mI;

    public TowRecyclerviewAdapter(Activity activity, List<HotBean> districtList, int i) {
        mActivity = activity;
