 ...
 */
public class MiImageListAdapter extends BaseRecyclerViewAdapter {

    private final List<UserAllInfo.ImageListBean> mImageList;
    private final Activity mActivity;

    public MiImageListAdapter(Activity activity, List<UserAllInfo.ImageListBean> imageList) {
        super(imageList);
