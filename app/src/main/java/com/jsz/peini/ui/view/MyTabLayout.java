    ...
    private void layoutViews() {
        ...
        if (mTitles != null && mTitles.length != 0) {
            for (int i = 0; i < mTitles.length; i++) {
                ...
                if (i == 0) {
                    titleView.setTextColor(mContext.getResources().getColor(R.color.RED_FB4E30));
    ...
    private void setTabTitleColor(int position) {
        ...
        if (mTitleViews != null && mTitleViews.size() != 0) {
            for (int key = 0; key < mTitleViews.size(); key++) {
                ...
                titleView.setTextColor(position == key ? mContext.getResources().getColor(R.color.RED_FB4E30) :
